...
export const Note = ({ loading, note, actions }) => {
  ...
  return (
    <div className="flex justify-center">
      <div className="lg:mx-0 max-w-sm p-4 w-full h-44 flex justify-between flex-col bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 hover:text-gray-500 dark:border-gray-700">
        <Link
